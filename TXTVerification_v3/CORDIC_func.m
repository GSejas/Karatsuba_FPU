function [seno,coseno] =cordic_Hardware(n,z0)
format long
%−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−−
%Entradas:
...
%cosntantesatan(2ˆ(−i)),dondei=0,1,2,...,n−1;dondeneslacantidaddeitera−
%cionesarealizarporelprograma.
fid=fopen(’LUT.txt’,’w’);
for(j=1:1:n)
	Angles(1,j)=atan(2ˆ(1−j));
...
for(i=0:1:n−1)
	...
	Xi1=Xi−sigma∗Yi∗2ˆ(−i);
	Yi1=Yi+sigma∗Xi∗2ˆ(−i);
