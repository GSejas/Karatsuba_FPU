...
module RegisterAdd_W48 ( clk, rst, load, D, Q );
  ...
  INVX2TS U2 ( .A(load), .Y(n12) );
  INVX2TS U3 ( .A(rst), .Y(n1) );
  CLKBUFX2TS U4 ( .A(n1), .Y(n30) );
  CLKBUFX2TS U5 ( .A(n1), .Y(n22) );
  CLKBUFX2TS U6 ( .A(n1), .Y(n28) );
  CLKBUFX2TS U7 ( .A(n1), .Y(n26) );
  CLKBUFX2TS U8 ( .A(n1), .Y(n24) );
  CLKBUFX2TS U9 ( .A(n12), .Y(n4) );
  INVX2TS U10 ( .A(n4), .Y(n2) );
  CLKBUFX2TS U11 ( .A(n12), .Y(n16) );
  AO22XLTS U12 ( .A0(n2), .A1(D[47]), .B0(n16), .B1(Q[47]), .Y(n97) );
  AO22XLTS U13 ( .A0(n2), .A1(D[46]), .B0(n16), .B1(Q[46]), .Y(n95) );
  AO22XLTS U14 ( .A0(n2), .A1(D[45]), .B0(n16), .B1(Q[45]), .Y(n93) );
  AO22XLTS U15 ( .A0(n2), .A1(D[44]), .B0(n4), .B1(Q[44]), .Y(n91) );
  AO22XLTS U16 ( .A0(n2), .A1(D[43]), .B0(n4), .B1(Q[43]), .Y(n89) );
  AO22XLTS U17 ( .A0(n2), .A1(D[42]), .B0(n4), .B1(Q[42]), .Y(n87) );
  AO22XLTS U18 ( .A0(n2), .A1(D[41]), .B0(n4), .B1(Q[41]), .Y(n85) );
  AO22XLTS U19 ( .A0(n2), .A1(D[40]), .B0(n4), .B1(Q[40]), .Y(n83) );
  AO22XLTS U20 ( .A0(n2), .A1(D[39]), .B0(n4), .B1(Q[39]), .Y(n81) );
  AO22XLTS U21 ( .A0(n2), .A1(D[38]), .B0(n4), .B1(Q[38]), .Y(n79) );
  INVX2TS U22 ( .A(n4), .Y(n6) );
  AO22XLTS U23 ( .A0(n6), .A1(D[37]), .B0(n4), .B1(Q[37]), .Y(n77) );
  AO22XLTS U24 ( .A0(n6), .A1(D[36]), .B0(n12), .B1(Q[36]), .Y(n75) );
  CLKBUFX2TS U25 ( .A(n12), .Y(n20) );
  AO22XLTS U26 ( .A0(n6), .A1(D[35]), .B0(n20), .B1(Q[35]), .Y(n73) );
  AO22XLTS U27 ( .A0(n6), .A1(D[34]), .B0(n16), .B1(Q[34]), .Y(n71) );
  AO22XLTS U28 ( .A0(n6), .A1(D[33]), .B0(n12), .B1(Q[33]), .Y(n69) );
  AO22XLTS U29 ( .A0(n6), .A1(D[32]), .B0(n20), .B1(Q[32]), .Y(n67) );
  AO22XLTS U30 ( .A0(n6), .A1(D[31]), .B0(n16), .B1(Q[31]), .Y(n65) );
  AO22XLTS U31 ( .A0(n6), .A1(D[30]), .B0(n12), .B1(Q[30]), .Y(n63) );
  AO22XLTS U32 ( .A0(n6), .A1(D[29]), .B0(n20), .B1(Q[29]), .Y(n61) );
  AO22XLTS U33 ( .A0(n6), .A1(D[28]), .B0(n16), .B1(Q[28]), .Y(n59) );
  INVX2TS U34 ( .A(n16), .Y(n8) );
  AO22XLTS U35 ( .A0(n8), .A1(D[27]), .B0(n12), .B1(Q[27]), .Y(n57) );
  CLKBUFX2TS U36 ( .A(n12), .Y(n10) );
  AO22XLTS U37 ( .A0(n8), .A1(D[26]), .B0(n10), .B1(Q[26]), .Y(n55) );
  AO22XLTS U38 ( .A0(n8), .A1(D[25]), .B0(n10), .B1(Q[25]), .Y(n53) );
  AO22XLTS U39 ( .A0(n8), .A1(D[24]), .B0(n10), .B1(Q[24]), .Y(n51) );
  AO22XLTS U40 ( .A0(n8), .A1(D[23]), .B0(n10), .B1(Q[23]), .Y(n49) );
  AO22XLTS U41 ( .A0(n8), .A1(D[22]), .B0(n10), .B1(Q[22]), .Y(n47) );
  AO22XLTS U42 ( .A0(n8), .A1(D[21]), .B0(n10), .B1(Q[21]), .Y(n45) );
  AO22XLTS U43 ( .A0(n8), .A1(D[20]), .B0(n10), .B1(Q[20]), .Y(n43) );
  AO22XLTS U44 ( .A0(n8), .A1(D[19]), .B0(n10), .B1(Q[19]), .Y(n41) );
  AO22XLTS U45 ( .A0(n8), .A1(D[18]), .B0(n10), .B1(Q[18]), .Y(n39) );
  INVX2TS U46 ( .A(n16), .Y(n14) );
  AO22XLTS U47 ( .A0(n14), .A1(D[17]), .B0(n10), .B1(Q[17]), .Y(n37) );
  CLKBUFX2TS U48 ( .A(n12), .Y(n18) );
  AO22XLTS U49 ( .A0(n14), .A1(D[16]), .B0(n18), .B1(Q[16]), .Y(n35) );
  AO22XLTS U50 ( .A0(n14), .A1(D[15]), .B0(n18), .B1(Q[15]), .Y(n33) );
  AO22XLTS U51 ( .A0(n14), .A1(D[14]), .B0(n18), .B1(Q[14]), .Y(n31) );
  AO22XLTS U52 ( .A0(n14), .A1(D[13]), .B0(n18), .B1(Q[13]), .Y(n29) );
  AO22XLTS U53 ( .A0(n14), .A1(D[12]), .B0(n18), .B1(Q[12]), .Y(n27) );
  AO22XLTS U54 ( .A0(n14), .A1(D[11]), .B0(n18), .B1(Q[11]), .Y(n25) );
  AO22XLTS U55 ( .A0(n14), .A1(D[10]), .B0(n18), .B1(Q[10]), .Y(n23) );
  AO22XLTS U56 ( .A0(n14), .A1(D[9]), .B0(n18), .B1(Q[9]), .Y(n21) );
  AO22XLTS U57 ( .A0(n14), .A1(D[8]), .B0(n18), .B1(Q[8]), .Y(n19) );
  AO22XLTS U58 ( .A0(load), .A1(D[7]), .B0(n18), .B1(Q[7]), .Y(n17) );
  AO22XLTS U59 ( .A0(load), .A1(D[6]), .B0(n20), .B1(Q[6]), .Y(n15) );
  AO22XLTS U60 ( .A0(load), .A1(D[5]), .B0(n20), .B1(Q[5]), .Y(n13) );
  AO22XLTS U61 ( .A0(load), .A1(D[4]), .B0(n20), .B1(Q[4]), .Y(n11) );
  AO22XLTS U62 ( .A0(load), .A1(D[3]), .B0(n20), .B1(Q[3]), .Y(n9) );
  AO22XLTS U63 ( .A0(load), .A1(D[2]), .B0(n20), .B1(Q[2]), .Y(n7) );
  AO22XLTS U64 ( .A0(load), .A1(D[1]), .B0(n20), .B1(Q[1]), .Y(n5) );
  AO22XLTS U65 ( .A0(load), .A1(D[0]), .B0(n20), .B1(Q[0]), .Y(n3) );
endmodule
...
module RecursiveKOA ( clk, rst, load_b_i, Data_A_i, Data_B_i, sgf_result_o );
  ...
  KOA_c_2 KOA_ASIC_main_KOA ( .Data_A_i(Data_A_i), .Data_B_i(Data_B_i), 
        .sgf_result_o(Result) );
