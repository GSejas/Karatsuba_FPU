...
HD_PWD='C:/Users/jsequeira/Proyectos/Karat/Karat_FPGA_Viv/Kat_FPGA.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log Sgf_Multiplication.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Sgf_Multiplication.tcl
